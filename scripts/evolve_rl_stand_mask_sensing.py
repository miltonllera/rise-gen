...
from scripts.evolve_rl_stand import RobotSimulationCollector
...
class RobotEvolution:
    def __init__(
        ...
        plot_robots: bool,
        mask_sensors: Tuple[bool, bool, bool],
    ):
        with ExceptionCatcher() as _:
            ...
            self.actor.encoder.set_mask(
                mask_voxel=mask_sensors[0],
                mask_node=mask_sensors[1],
                mask_edge=mask_sensors[2],
            )
            self.critic.encoder.set_mask(
                mask_voxel=mask_sensors[0],
                mask_node=mask_sensors[1],
                mask_edge=mask_sensors[2],
            )
...
if __name__ == "__main__":
    ...
    evo = RobotEvolution.remote(
        ...
        mask_sensors=(mask_voxel, mask_node, mask_edge),
    )
