                ...
                if success and len(observation[robot_idx]) > self.min_actions:
                    ...
                    for i, (o, a) in enumerate(zip(obs, act)):
                        ...
                        if i < len(obs) - 1:
                            ...
                            reward = t.dot(next_movement, reward_dir) / voxel_size
...
if __name__ == "__main__":
    ...
    terrain = generate_noisy_hill_terrain(100, 100, 0.02, 3, 0.005, 1)
    env_config = generate_env_with_terrain(10, 10, terrain)

    # terrain = generate_wave_ground(100, 100, 10, 5, 0.5)
    # env_config = generate_env_with_terrain(10, 10, terrain)
